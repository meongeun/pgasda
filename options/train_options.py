...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--src_train_datafile', type=str, default='train2.txt', help='stores data list, in src_root')
        parser.add_argument('--tgt_train_datafile', type=str, default='train2.txt', help='stores data list, in tgt_root')
        parser.add_argument('--print_freq', type=int, default=32, help='frequency of showing training results on console')
        parser.add_argument('--save_result_freq', type=int, default=10, help='frequency of saving the latest prediction results')
        parser.add_argument('--save_latest_freq', type=int, default=20, help='frequency of saving the latest trained model')
        ...
        parser.add_argument('--lr_task', type=float, default=2e-6, help='initial learning rate for adam')
        # parser.add_argument('--lr_trans', type=float, default=5e-5, help='initial learning rate for adam')
        parser.add_argument('--lr_trans', type=float, default=2e-4, help='initial learning rate for adam')

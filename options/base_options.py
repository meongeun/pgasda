...
class BaseOptions():
    def __init__(self, ssh = False):
        ...
        self.ssh = ssh
        if self.ssh == True:
            self.folder = '/home/cvlab/meongeun'
        else:
            self.folder = '/media/data1'
    def initialize(self, parser):

        parser.add_argument('--src_root', type=str, default=f'{self.folder}/datasets/vkitti', help='path to source dataset')
        parser.add_argument('--tgt_root', type=str, default=f'{self.folder}/datasets/kitti', help='path to target dataset')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=f'{self.folder}/results/pgasda', help='models are saved here')
        ...
        parser.add_argument("--frame_idxs",nargs="+",type=int,help="frames to load",default=[0, -1, 1])
        parser.add_argument('--num_frames', default=2)
        parser.add_argument('--num_layers', default=18, choices=[18, 34, 50, 101, 152])
        parser.add_argument('--weights_init', default='pretrained', choices=["pretrained", "scratch"])
